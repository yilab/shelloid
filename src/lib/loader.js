...
{
	var p = serverCtx.appCtx.basePath + "/" + serverCtx.appCtx.config.dirs.routes;
	p = path.normalize(p);
...
{
	var p = serverCtx.appCtx.basePath + "/" + serverCtx.appCtx.config.dirs.auth;
	p = path.normalize(p);
...
{
	var p = serverCtx.appCtx.basePath + "/" + serverCtx.appCtx.config.dirs.interfaces;
	p = path.normalize(p);
